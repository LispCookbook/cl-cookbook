...
The [cl-csv](https://github.com/AccelerationNet/cl-csv)
library handles CSV parsing, including quoted fields,
custom separators, and streaming.
...
Loop over rows for side effects with `do-csv`:
...
For writing CSV, use `cl-csv:write-csv`:
