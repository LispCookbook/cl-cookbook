...
We have a few generators at our disposal, for example:
...
And we have a function to run 100 tests, taking each turn a new value from the given generators: `for-all`:
