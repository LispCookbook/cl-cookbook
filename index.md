...
* [Practical Common Lisp](http://www.gigamonkeys.com/book/) by Peter Seibel (better read with [a Firefox add-on](https://addons.mozilla.org/de/firefox/addon/beautify-practical-common-lisp/))
