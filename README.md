...
Incremental builds are active in the Docker container so if you make a change to the book, you can hit refresh in your browser and you should be able to see your changes.
